...
Github actions will then package and deploy your code to an app called [Rename Faces by Room Name](https://app.pollination.cloud/mostapha/applications/rename-faces-by-room-name)
